        ...
        <div className="settings-grid enter d1">
          ...
          <div className="panel">
            ...
            <form action={updateProfile} className="settings-edit-form">
              ...
              <label className="form-label-group">Public profile<select className="dark-input" name="profile_visibility" defaultValue={profile?.profile_visibility || "project"}><option value="project">Project members only</option><option value="public">Public and shareable</option></select><span className="settings-readonly-note">Public profiles show approved identity, media and credit names only—never project files.</span></label>
